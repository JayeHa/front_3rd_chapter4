...
- [\[심화과제\] CDN과 성능최적화](#심화과제-cdn과-성능최적화)
  ...
  - [4. 결론](#4-결론)
    - [덧) Lighthouse 결과](#덧-lighthouse-결과)
- [참고 자료](#참고-자료)
  - [공식문서](#공식문서)
...
측정 결과, 도입 전후 Lighthouse에서 HTTP 사용으로 인해 발생한 Best Practices 항목의 감점을 제외하면, **성능상의 유의미한 차이는 확인되지 않았습니다.**
<img src="/public/라이트하우스 측정결과.png"/>
